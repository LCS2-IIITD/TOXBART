...
--output_dir sbic_config4_model --tox_model_dir ../tox_bert/bert-toxic-signals-probab/<tox-bert-checkpoint-folder> \\
...
--output_dir latent_config4_model --tox_model_dir ../tox_bert/bert-toxic-signals-probab/<tox-bert-checkpoint-folder> \\
...
if __name__ == "__main__":
    ...
    model = ToxBARTC3.from_pretrained("facebook/bart-base")
